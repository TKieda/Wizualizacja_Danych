...
# plt.axis([0, 6, 0, 20]) #tutaj określamy listę parametrów w postaci [xmin, xmax, ymin, ymax]
# plt.show()
#
...
# # każdej kolejnej wartości wektora wykresu.
# # Reasumując dla pierwszego punktu wykresu będą brane poniższe wartości
...
# subplot przyjmuje 3 argumenty (nrows, ncols, index).
# Odpowiednio jest to ilość wierszy gridu, ilość kolumn oraz indeks definiowanego właśnie wykresu
# (indeksy rozpoczynają się od 1 i kończą na nrows*ncols)
